...
* **Supporters:**
    ...
    * Creators can generate video scripts for their supporters' requests using the Dcrowd LLM.
...
**Theta Video management API**: Creators can back up all their video content to Theta Cloud directly from the Dcrowd app when they are connected with the address associated with the creator page creation.
